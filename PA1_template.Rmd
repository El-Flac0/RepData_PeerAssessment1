...
#The Plot
ggplot(intStepMean, aes(x=interval, y=intSteps)) + geom_line() + xlim(0, 2500) + scale_x_continuous(breaks=(seq(0,2500, by=200))) + xlab("5-Minute Interval") + ylab("Mean Step Count")
```
...
# The plot
hist(histTotals$steps, breaks=10, xlim=c(0,25000), xlab="Daily Total Step Count w. imputed data")
# reporting
...
#The Plot
ggplot(weekDat1, aes(x=interval, y=steps, colour=weekday)) + geom_line() + xlim(0, 2500) + scale_x_continuous(breaks=(seq(0,2500, by=200))) + xlab("5-Minute Interval") + ylab("Mean Step Count") + facet_grid(weekday~.)
```
